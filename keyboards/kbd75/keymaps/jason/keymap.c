...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT(
     ...
     MO(FNC),    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,           KC_ENT,          KC_HOME,
    KC_LSFT, KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,            KC_UP,  KC_END,
    KC_LCTL, KC_LGUI, KC_LALT,                    KC_SPC,  KC_SPC,  KC_SPC,                   KC_RALT, MO(FNC), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),
   ...
   /*--------------------------------------------------------------------------------------------------------.------.
    ...
    |--------------------------------------------------------------------------------------------------------|------| */
  [FNC] = LAYOUT(
    _______, RGB_M_P, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU,   RESET, _______, _______,
    ...
    _______, BL_TOGG, BL_BRTG,  BL_INC,  BL_DEC, BL_STEP, _______, _______,   KC_UP, _______, _______, _______, _______, _______,          _______,
  ...
  //   _______, _______, _______, _______,  BL_DEC, BL_TOGG,  BL_INC, BL_STEP, _______, _______, _______, _______, _______, _______, KC_PGDN,
  //   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
